...
#define ARM_SMCCC_PKVM_FUNC_G2G_SHARE		32
#define ARM_SMCCC_PKVM_FUNC_G2G_QUERY		33
#define ARM_SMCCC_PKVM_FUNC_G2G_UNSHARE		34
...
#define ARM_SMCCC_VENDOR_HYP_PKVM_G2G_SHARE_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_PKVM_FUNC_G2G_SHARE)

#define ARM_SMCCC_VENDOR_HYP_PKVM_G2G_QUERY_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP, \
			   ARM_SMCCC_PKVM_FUNC_G2G_QUERY)

#define ARM_SMCCC_VENDOR_HYP_PKVM_G2G_UNSHARE_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP, \
			   ARM_SMCCC_PKVM_FUNC_G2G_UNSHARE)
